...
{
    public static class OdinStringRegexExtensions
    {
        /// <summary>
        /// 中国身份号码
        /// </summary>
        /// <returns></returns>
        public static string RegexIp4 { get; set; } = @"\b(([01]?\d?\d|2[0-4]\d|25[0-5])\.){3}([01]?\d?\d|2[0-4]\d|25[0-5])\b";
        ...
        {
            Match match = Regex.Match(ip, pattern??RegexIp4);
            return match.Value;
        }
    }
}