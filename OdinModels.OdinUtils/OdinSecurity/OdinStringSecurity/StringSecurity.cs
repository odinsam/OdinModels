...
namespace OdinModels.OdinUtils.OdinSecurity.OdinStringSecurity
{
    public static class StringSecurity
    {
        ...
        public static JObject AddCardIdMark(this Object entity, string fieldName, string newfieldName = null, string strMark = null)
        {
            ...
            {
                var cardIdMark = Regex.Replace(cardId, OdinStringRegexExtensions.RegexChinaCardId, strMark ?? OdinStringRegexExtensions.StringMarkChinaCardId);
                var jobj = JObject.Parse(JsonConvert.SerializeObject(entity));
        ...
        public static JObject AddPhoneMark(this Object entity, string fieldName, string newfieldName = null, string strMark = null)
        {
            ...
            {
                var phoneMark = Regex.Replace(phone, OdinStringRegexExtensions.RegexChinaMobile, strMark ?? OdinStringRegexExtensions.StringMarkChinaMobile);
                var jobj = JObject.Parse(JsonConvert.SerializeObject(entity));
